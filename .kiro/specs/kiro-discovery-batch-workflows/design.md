...
| CrossSpecReviewWorkflow | Review | generated specs の boundary と contract consistency を確認する | 5.1, 5.2, 5.3, 5.4, 5.5, 5.6, 6.4 | generated specs P0 | Batch |
| BatchRemediationCoordinator | Controller | worker failure と review issue の next action をまとめる | 4.2, 4.4, 5.4, 5.5, 5.6 | BatchWorkerDispatcher P0, CrossSpecReviewWorkflow P0 | State |
