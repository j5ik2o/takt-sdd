...
| SpecGenerationValidationHarness | Validation | spec generation workflow と artifact contract の drift を検出する | 6.1, 6.2, 6.3, 6.4, 6.5 | workflow files P0, facets P0, shared contracts P0 | Service, Batch |
