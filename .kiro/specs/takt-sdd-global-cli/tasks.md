...
- [x] 2. (P) 公開 package 境界と build chain の確立
  ...
  - _Requirements: 1.1, 1.4, 4.2, 7.1, 7.2, 7.3_
...
- [x] 3.1 (P) 公開 command catalog と除外分類を定義する
  ...
  - _Requirements: 1.2, 5.1, 5.2, 5.7_
  - _Boundary:_ CommandCatalog
  - _Depends:_ none

- [x] 3.2 packaged asset source による init command を実装する
...
- [x] 3.3 workflow 実行の preflight と spawn を実装する
  ...
  - _Requirements: 4.4, 4.5, 4.6, 5.3, 6.3, 6.4, 6.5, 6.6_
...
- [x] 5.2 isolated global install smoke を実装する
...
- [x] 6. global CLI documentation の更新
