...
1. Read existing artifacts for context (`openspec/changes/<name>/proposal.md`, `design.md`, `tasks.md`)
...
- **Don't auto-capture** - Insights will be captured automatically as a memo after exploration ends
